...
place_clb_grid(parent_inst='tile_pile_west', lx=LX, ly=LY, mx=4, my=10, clb_dimensions=(700, 700), buff=(50,50))
add_placement('mac', 3100, 250)
place_clb_grid(parent_inst='tile_pile_east', lx=LX+5300, ly=LY, mx=3, my=10, clb_dimensions=(700, 700), buff=(50,50))

for i in range(3):
    name = WB_INST_NAME.format(i=i)
    add_placement(name, 1250 + i*1750, 100)
